...
describe("Testing PokemonInfo component", () => {
  const wrapper = render(<PokemonInfo pokemon={pokemon} />);

  test("PokemonInfo component should be defined", () => {
    expect(wrapper).toBeDefined();
  });

  test("PokemonInfo component should render correctly", () => {
